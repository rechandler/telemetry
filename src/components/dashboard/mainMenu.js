...
import {
  ...
  const navigation = [
    { name: 'Home', href: '/menu', icon: HomeIcon, current: true },
    { name: 'Telemetry', href: '/menu/telemetryMenu', icon: FlagIcon, current: false },
        ...
        <div>
            ...
            <div className="md:pl-64 flex flex-col flex-1">
                ...
                <Routes>
                    ...
                    <Route exact path="/telemetryMenu" element={<TelemetryMenu />} />
                </Routes>
                </main>
            </div>
        </div>
